...
bin/{{SERVICE_BIN}}d: ../../corelibs/OpenStorage/lib/libopenstorage.a

bin/{{SERVICE_BIN}}d: ../../corelibs/BaseFoundation/lib/libbasefoundation.a

bin/{{SERVICE_BIN}}d: ../../contribs/ApacheThrift/lib/libapachethrift.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libspecialcontribs.a

bin/{{SERVICE_BIN}}d: ../../contribs/Poco/lib/libpocoall.a

bin/{{SERVICE_BIN}}d: ../../contribs/LibEvent/lib/libevent.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libetcd-cpp-api.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libares.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libboost_atomic.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libboost_chrono.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libboost_date_time.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libboost_locale.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libboost_regex.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libboost_system.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libboost_thread.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libcpprest.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgpr.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc++.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc++_core_stats.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc++_cronet.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc++_error_details.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc++_reflection.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc++_unsecure.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpc_unsecure.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libgrpcpp_channelz.a

bin/{{SERVICE_BIN}}d: ../../contribs/SpecialContribs/lib/libprotobuf.a

bin/{{SERVICE_BIN}}d: ${OBJECTFILES}
	${MKDIR} -p bin
	${LINK.cc} -o bin/{{SERVICE_BIN}}d ${OBJECTFILES} ${LDLIBSOPTIONS}
