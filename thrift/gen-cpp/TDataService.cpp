...
TErrorCode::type TDataServiceClient::putData(const TData& data)
{
  send_putData(data);
  return recv_putData();
}

void TDataServiceClient::send_putData(const TData& data)
{
  int32_t cseqid = 0;
...
void TDataServiceProcessor::process_putData(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->putData(args.data);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
TErrorCode::type TDataServiceConcurrentClient::putData(const TData& data)
{
  int32_t seqid = send_putData(data);
  return recv_putData(seqid);
}

int32_t TDataServiceConcurrentClient::send_putData(const TData& data)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("putData", ::apache::thrift::protocol::T_CALL, cseqid);
