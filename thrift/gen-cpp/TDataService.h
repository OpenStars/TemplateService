...
class TDataServiceIf {
 public:
  ...
  virtual TErrorCode::type putData(const TData& data) = 0;
};
...
class TDataServiceNull : virtual public TDataServiceIf {
 public:
  ...
  TErrorCode::type putData(const TData& /* data */) {
...
typedef struct _TDataService_putData_args__isset {
  _TDataService_putData_args__isset() : data(false) {}
  bool data :1;
...
class TDataServiceClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const TData& data);
  void send_putData(const TData& data);
...
class TDataServiceMultiface : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const TData& data) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->putData(data);
    }
    return ifaces_[i]->putData(data);
  }
...
class TDataServiceConcurrentClient : virtual public TDataServiceIf {
 ...
 public:
  ...
  TErrorCode::type putData(const TData& data);
  int32_t send_putData(const TData& data);
