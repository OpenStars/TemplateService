...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TErrorCode putData(TData data)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := openstarsprofile.NewTPlatformProfileServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getData":
    ...
    value0 := openstarsprofile.TKey(argvalue0)
  ...
  case "putData":
    ...
    argvalue0 := openstarsprofile.NewTData()
    err25 := argvalue0.Read(jsProt24)
    if err25 != nil {
      Usage()
      return
    }
    value0 := openstarsprofile.TData(argvalue0)
